...
object ActivitiesProver {
    ...
    private fun provideArtsAndCrafts(): List<TwemojiIcon> = listOf(
    ...
    // region Award medals
    private fun provideAwardMedals(): List<TwemojiIcon> = listOf(
    ...
    // region Events
    private fun provideEvents(): List<TwemojiIcon> = listOf(
    ...
    // region Games
    private fun provideGames(): List<TwemojiIcon> = listOf(
    ...
    // region Sports
    private fun provideSports(): List<TwemojiIcon> = listOf(
