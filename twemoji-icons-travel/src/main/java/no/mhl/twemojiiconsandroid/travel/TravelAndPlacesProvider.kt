...
object TravelAndPlacesProvider {
    ...
    // region Hotel
    private fun provideHotel(): List<TwemojiIcon> = listOf(
    ...
    // region Building
    private fun provideBuilding(): List<TwemojiIcon> = listOf(
    ...
    // region Geographic
    private fun provideGeographic(): List<TwemojiIcon> = listOf(
    ...
    // region Map
    private fun provideMap(): List<TwemojiIcon> = listOf(
    ...
    // region Religious
    private fun provideReligious(): List<TwemojiIcon> = listOf(
    ...
    private fun provideSkyAndWeather(): List<TwemojiIcon> = listOf(
    ...
    // region Time
    private fun provideTime(): List<TwemojiIcon> = listOf(
    ...
    private fun provideTransportAir(): List<TwemojiIcon> = listOf(
    ...
    private fun provideTransportGround(): List<TwemojiIcon> = listOf(
    ...
    private fun provideTransportWater(): List<TwemojiIcon> = listOf(
