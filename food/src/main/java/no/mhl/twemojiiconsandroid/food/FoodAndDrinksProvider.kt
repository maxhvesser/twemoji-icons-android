...
object FoodAndDrinksProvider {
    ...
    // region Dishware
    private fun provideDishware(): List<TwemojiIcon> = listOf(
    ...
    // region Drinks
    private fun provideDrinks(): List<TwemojiIcon> = listOf(
    ...
    // region Asian
    private fun provideAsian(): List<TwemojiIcon> = listOf(
    ...
    // region Fruit
    private fun provideFruit(): List<TwemojiIcon> = listOf(
    ...
    // region Prepared
    private fun providePrepared(): List<TwemojiIcon> = listOf(
    ...
    // region Sweets
    private fun provideSweets(): List<TwemojiIcon> = listOf(
    ...
    // region Vegetables
    private fun provideVegetables(): List<TwemojiIcon> = listOf(
