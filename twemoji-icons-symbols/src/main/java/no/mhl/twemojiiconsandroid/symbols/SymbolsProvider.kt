...
object SymbolsProvider {
    ...
    // region Alphanum
    private fun provideAlphanum(): List<TwemojiIcon> = listOf(
    ...
    // region Arrow
    private fun provideArrow(): List<TwemojiIcon> = listOf(
    ...
    // region Av
    private fun provideAv(): List<TwemojiIcon> = listOf(
    ...
    // region Gender
    private fun provideGender(): List<TwemojiIcon> = listOf(
    ...
    // region Geometric
    private fun provideGeometric(): List<TwemojiIcon> = listOf(
    ...
    // region Keycap
    private fun provideKeycap(): List<TwemojiIcon> = listOf(
    ...
    // region Religion
    private fun provideReligion(): List<TwemojiIcon> = listOf(
    ...
    private fun provideTransportSign(): List<TwemojiIcon> = listOf(
    ...
    // region Warning
    private fun provideWarning(): List<TwemojiIcon> = listOf(
    ...
    // region Zodiac
    private fun provideZodiac(): List<TwemojiIcon> = listOf(
