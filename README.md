...
The latest version of twemoji-icons-android is `0.1.7` and this is marked currenrtly as pre-release and should be considered as such due to lack of performance optimizations.
